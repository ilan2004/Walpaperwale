const all_items = [
  {
    title: "Wallpapers",
    description: "Stylish wallpapers to transform any space with elegant patterns and textures.",
  ...
  {
    title: "Customized Wallpapers",
    description: "Personalized designs tailored to your unique style and space requirements.",
